...
void solve_single(real_t* __restrict densities, const real_t* __restrict supply_rates,
				  const real_t* __restrict uptake_rates, const real_t* __restrict supply_target_densities,
